...
// the window-control buttons opt out with `ic-no-drag`.
export function TitleBar() {
  return (
    <div className="ic-drag relative flex h-[38px] flex-shrink-0 items-center justify-end border-b border-[#EEF0F3] bg-[#FAFBFC] pl-3.5 pr-1.5">
